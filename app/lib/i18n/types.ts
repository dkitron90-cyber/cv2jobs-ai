...
export type Messages = {
  ...
  matcher: {
    ...
    sendAssistedBanner: string;
    sendAssistedExplain: string;
    sendStepCvPrepare: string;
    sendMarkAssistedOutreach: string;
    sendMarkAssistedApply: string;
    applyVerifiedHint: string;
  };
  auth: {
  ...
  space: {
    ...
    assistedOutreachBadge: string;
    assistedApplyBadge: string;
    remove: string;
    savedOn: string;
